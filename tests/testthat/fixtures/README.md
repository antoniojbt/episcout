...
This directory contains small, pinned, publicly available biomedical datasets for specification-first EDA tests.
...
The regeneration script may require optional source packages such as `medicaldata`, but those packages are not required to use the committed fixtures in offline tests.
