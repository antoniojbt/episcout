...
Below are a number of examples of how to use lower-level episcout helper
functions. For a complete specification-first EDA workflow, see the
`specification-first-eda` vignette.
