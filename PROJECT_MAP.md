...
- No roadmap is active: completed design issue-310/spec-044/PR-317 defines the mark-aware external palette contract for filled categorical marks. Its active implementation successor is issue-316; issue-311's generic EDA creation-time styling hook remains blocked until issue-316 is accepted and closed out. `future/TODOs.md` is the synchronised task index, `future/README.md` defines the lifecycle and `future/changelog.md` records completed outcomes.
