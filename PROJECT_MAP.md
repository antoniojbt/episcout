...
- No roadmap is active: design issue-310/spec-044 is in review through PR-317 and defines the mark-aware external palette contract for filled categorical marks. Its implementation successor is issue-316; issue-311's generic EDA creation-time styling hook remains blocked until this design is accepted and closed out. `future/TODOs.md` is the synchronised task index, `future/README.md` defines the lifecycle and `future/changelog.md` records completed outcomes.
