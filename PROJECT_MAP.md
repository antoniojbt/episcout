...
- Completed design spec `026-epi-geo-series-plan` and implementation spec `027-epi-geo-phase-a` are preserved under `future/specs/done/`; issue #226 closed through PR #234, merged as `b37b391`. Read-only PostGIS issue #233 is the ready-next tracker after this closeout becomes canonical, while aggregate EDA-coordinate integration remains deferred in the design record.
