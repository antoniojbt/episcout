...
- No roadmap is active: completed issue-310/spec-044/PR-317 and its implementation successor issue-316/spec-045/PR-319 define and add exact categorical fill mappings. Issue-311/spec-046 is the active dependent EDA creation-time styling-hook lane. `future/TODOs.md` is the synchronised task index, `future/README.md` defines the lifecycle and `future/changelog.md` records completed outcomes.
