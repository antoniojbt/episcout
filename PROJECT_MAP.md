...
| Approved cleaning rules and processed outputs | `epi_eda_approved_rules()`, `epi_eda_apply_cleaning_rules()` | `R/eda_cleaning.R` | `tests/testthat/test-eda-cleaning.R` including gated PostgreSQL parity and rollback | Function help, `README.md`, `vignettes/specification-first-eda.Rmd` |
