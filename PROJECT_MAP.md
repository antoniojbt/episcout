...
- Issue #243 is the active planning target for draft spec `030-simplify-core-eda-controls-geo-outputs`. Its prerequisite/planning gate repairs workflow checks for checkout paths containing spaces and fixes the breaking semantic EDA, explicit point-map and specialised security-policy contracts before package implementation.
