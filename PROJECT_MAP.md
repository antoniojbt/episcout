...
- Longitudinal population and key QC completed through issue-346/spec-048/PR-350 at `commit-54ed478` with lifecycle closeout PR-351. Generic longitudinal variable drift completed through issue-347/spec-049/PR-352 at `commit-b4eddf0` with lifecycle closeout PR-353. Issue-348 adds the bounded adjacent state-transition interface; its GitHub lifecycle remains the live work record, and issue-349 remains gated behind it.
