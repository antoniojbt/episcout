...
- Longitudinal population and key QC completed through issue-346/spec-048/PR-350 at `commit-54ed478` with lifecycle closeout PR-351. Issue-347 is the queued successor for generic longitudinal drift; later transition and longitudinal-description work remains separately gated.
