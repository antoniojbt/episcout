...
- Completed design spec `026-epi-geo-series-plan`, implementation spec `027-epi-geo-phase-a` and implementation spec `028-epi-geo-postgis` are preserved under `future/specs/done/`; issue #226 closed through PR #234, merged as `b37b391`, and issue #233 closed through PR #238, merged as `460acd0`. After closeout PR #239 merged as `cdeb360`, aggregate EDA-coordinate issue #237 activated as implementation spec `029-eda-reviewed-coordinate-roles`; its implementation may stack on the green planning PR under the owner's explicit instruction.
