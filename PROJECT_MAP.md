...
- Longitudinal population and key QC completed through issue-346/spec-048/PR-350 at `commit-54ed478` with lifecycle closeout PR-351. Generic longitudinal variable drift completed through issue-347/spec-049/PR-352 at `commit-b4eddf0`; issue-348 is the queued state-transition successor and issue-349 remains gated behind it.
