...
- Probabilistic-linkage roadmap issue [#360](https://github.com/antoniojbt/episcout/issues/360) is active under design spec 052. Draft PR #363 defines the contract, draft PR #364 implements foundation issue #361, and stacked draft PR #365 implements terminal scoring/validation issue #362 plus the synthetic reference guide. All remain unmerged and require independent behaviour-sensitive review; probabilistic output remains outside the exact registry unless a caller separately reviews and promotes a crosswalk.
