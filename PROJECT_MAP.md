...
- Owner roadmaps #274/#275 retain all seven `epi_sec_*` exports while removing package governance authority. Design issue #276 is active as spec `034-retained-epi-sec-technical-contract`; it changes no current package behaviour, and its first implementation tracker is drafted but not yet created. Documentation issue #269 remains paused until the behaviour sequence is stable.
