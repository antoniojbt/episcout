...
- Archived the completed SDD/TDD planning docs under `archive/eda_sdd_tdd_r1_archive/`.
...
- Added the specification-first EDA SDD, ADRs, roadmap, TDD instructions and review checklist.
- Added external fixture files and fixture-backed tests for the initial EDA contracts.
- Implemented specification loading, validation, schema checks and missingness profiling.
...
- Added project-template tests, `inst/project-template/`, and `epi_eda_create_project()`.
