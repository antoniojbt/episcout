...
Use the root-level `future/` directory for next-phase planning:
...
- SDD and ADR files for the specification-first EDA layer.
- The original TDD-first PR sequence.
- Repository audit notes and review checklists.
- Historical Codex instruction blocks.
- Summary and changelog for the completed EDA planning flow.

## What Moved To `future/`

- Deferred Phase 1 helper stabilization.
