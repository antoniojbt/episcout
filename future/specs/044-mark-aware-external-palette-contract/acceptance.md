...
- [x] Missingness and category-order preservation are specified without changing analytical data.
- [x] The historical institutional exports have an explicit retain decision for this non-breaking slice.
...
- [ ] A draft planning PR passes review, required workflow checks and post-merge closeout.
