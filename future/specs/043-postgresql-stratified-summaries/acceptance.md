...
- [x] One unchanged public profiler accepts both data-frame and PostgreSQL sources.
- [x] Returned PostgreSQL components work unchanged with Table 1 and categorical display.
- [x] Aggregate SQL, hand-derived fixtures and parity tests cover counts, denominators, ordering and edge cases.
- [x] No PostgreSQL stratified query returns a raw analysis row or value vector.
