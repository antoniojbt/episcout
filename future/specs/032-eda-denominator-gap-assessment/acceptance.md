...
- [x] #245 aggregate-delivery ownership and no-database renderer boundaries are preserved.
- [x] The remaining Table 1, frequency-companion and report gaps are concrete and testable.
- [x] Missing/not-applicable meaning is not inferred or added to the semantic dictionary.
