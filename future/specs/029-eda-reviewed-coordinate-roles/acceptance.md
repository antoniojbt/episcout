...
- [ ] Planning PR is green before the stacked implementation begins.
- [ ] Executable tests fail for the intended missing behaviour before implementation and pass afterward.
- [ ] Focused, live PostgreSQL, lint, local, CRAN-oriented and upstream checks are recorded.
- [ ] User documentation and generated help describe the additive contract and safety boundary.
