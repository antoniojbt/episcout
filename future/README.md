...
Active [issue-271](https://github.com/antoniojbt/episcout/issues/271)/`spec-039-reviewable-qc-cleaning-proposals` is the current roadmap implementation lane after its planning contract was accepted through merged PR-298. It adds the separate aggregate evidence and pending-proposal contract; [issue-272](https://github.com/antoniojbt/episcout/issues/272) and [issue-273](https://github.com/antoniojbt/episcout/issues/273) remain staged successors.
