...
Design issue [#276](https://github.com/antoniojbt/episcout/issues/276) is active as spec `034-retained-epi-sec-technical-contract` under owner roadmaps [#274](https://github.com/antoniojbt/episcout/issues/274) and [#275](https://github.com/antoniojbt/episcout/issues/275). It changes no package behaviour and contains a complete first implementation-issue draft; that GitHub successor has not yet been created. No package-code specification is active, and longitudinal documentation issue [#269](https://github.com/antoniojbt/episcout/issues/269) remains paused for reconciliation after behaviour is stable.
