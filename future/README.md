...
Completed design issue [#276](https://github.com/antoniojbt/episcout/issues/276)/spec `034-retained-epi-sec-technical-contract` records the accepted technical contract under owner roadmaps [#274](https://github.com/antoniojbt/episcout/issues/274) and [#275](https://github.com/antoniojbt/episcout/issues/275). Design PR [#277](https://github.com/antoniojbt/episcout/pull/277) merged to canonical `master` as `8641abe`, all required CI passed, and the design changed no package behaviour. Open issue [#278](https://github.com/antoniojbt/episcout/issues/278) is the next implementation tracker, but implementation has not begun and remains non-dispatchable until this closeout is canonical. No package-code specification is active, and longitudinal documentation issue [#269](https://github.com/antoniojbt/episcout/issues/269) remains paused for reconciliation after behaviour is stable.
