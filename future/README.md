...
Draft [issue-271](https://github.com/antoniojbt/episcout/issues/271)/`spec-039-reviewable-qc-cleaning-proposals` is the current roadmap planning lane. It fixes a separate aggregate evidence and pending-proposal contract before package implementation; [issue-272](https://github.com/antoniojbt/episcout/issues/272) and [issue-273](https://github.com/antoniojbt/episcout/issues/273) remain staged successors.
