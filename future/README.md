...
Probabilistic-linkage roadmap issue [#360](https://github.com/antoniojbt/episcout/issues/360) is active under design spec 052. Its ordered implementation successors are [#361](https://github.com/antoniojbt/episcout/issues/361) for declarations, preparation, bounded candidates and comparisons, then [#362](https://github.com/antoniojbt/episcout/issues/362) for Fellegi-Sunter scoring, classification, validation and the synthetic reference guide. GitHub issues remain the authoritative return point; `TODOs.md` mirrors the sequence without replacing live GitHub state.
