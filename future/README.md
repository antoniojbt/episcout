...
Completed spec `025-curp-validation-and-reconciliation` records issue [#225](https://github.com/antoniojbt/episcout/issues/225) and PR [#231](https://github.com/antoniojbt/episcout/pull/231), merged to canonical `master` as `7e42f22`. Checksum verification remains `not_verified`; owner-resolved evidence issue [#230](https://github.com/antoniojbt/episcout/issues/230) closed without adopting an unofficial algorithm. Issue [#226](https://github.com/antoniojbt/episcout/issues/226) is in review under implementation spec `027-epi-geo-phase-a` and draft PR [#234](https://github.com/antoniojbt/episcout/pull/234).
