...
Completed specifications live under `specs/done/`. Release `0.4.0` is published from commit `ea2a3f1`; CRAN work remains deferred under issue #81, and owner-only Codecov containment remains parallel under issue #213.
