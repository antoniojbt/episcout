...
Completed [issue-271](https://github.com/antoniojbt/episcout/issues/271)/`spec-039-reviewable-qc-cleaning-proposals` records planning [PR-298](https://github.com/antoniojbt/episcout/pull/298) and implementation [PR-299](https://github.com/antoniojbt/episcout/pull/299), merged as `commit-9f48a06` and `commit-78a4776`. [issue-272](https://github.com/antoniojbt/episcout/issues/272) is the next implementation slice, while [issue-273](https://github.com/antoniojbt/episcout/issues/273) remains staged behind it.
