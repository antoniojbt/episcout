...
#'
#' @param freq Frequency count, an integer. Defaults to 1 (so will return original plus any repeating values)
#'
#' @note   Creates a table with frequencies, checks those which have more than 1 (or value passed to freq and considers these as variables with duplicates) and extracts them.
#'
