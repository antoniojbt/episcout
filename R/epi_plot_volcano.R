...
#' @param p_val Numeric vector of raw p-values (will be transformed to `-log10(p_val)`).
...
#'
#' @note Assumes small effect sizes with vertical cut-offs at 0.8 and 1.2 log2 fold change and a horizontal cut-off corresponding to a p-value of 0.05.
#'
#' @seealso [epi_plot_list()], [epi_plots_to_grid()], [epi_plot_cow_save()], [graphics::plot()]
#'
