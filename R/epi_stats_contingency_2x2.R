...
#' @param contingency_2x2_list A list of contingency tables generated by `epi_stats_contingency_2x2_tables()` (used by `rename_contingency_2x2_cols()`).
#'
#' @return
...
#'
#' These functions simply forward their arguments to the newer `epi_stats_contingency_2x2_*` implementations.
