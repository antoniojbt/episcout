######################
# Helper functions for phenotype data processing and cleaning
...
######################
# Read all files with a consistent convenience function
# Note that options are hard-coded. You are probably better off using the
# standard read.csv(), data.table::fread() or other functions.
...
# Strings are read as character only
# Hard coded NA strings are given:
# c(-Inf, 'NULL', NULL,
#   '.', # '', ' ',
#   'NA', 'NaN', NA, '<NA>'
#   )
